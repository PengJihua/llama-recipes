...
class COVID19Dataset_2(Dataset):
    ...
    def __init__(self, root_dir, transform=None):
        ...
        # 由于标签信息是string,需要一个字典转换为模型训练时的int类型
    ...
    def _get_img_info(self):
        """
        实现数据集的读取，将硬盘中的数据路径，标签读取出来，存在一个list中（path,label）
        :return:
        """
...
class COVID19Dataset_3(Dataset):
    ...
    def __init__(self, root_dir, path_csv, mode, transform=None):
        """
        获取数据集的路径、预处理的方法。
        由于数据划分体现在同一份文件中，因此需要设计train/valid模式
        :param root_dir:
        :param path_csv:
        :param mode:
        :param transform:
    ...
    def _get_img_info(self):
        """
        实现数据集的读取，将硬盘中的数据路径，标签读取进来，存在一个list中（path,label）
        :return:
        """
...
if __name__=="__main__":
    ##############COVID19Dataset_2###################
    root_dir_train=r"D:\AI\File\PyTorch-Tutorial-2nd-main\PyTorch-Tutorial-2nd-main\data\covid-19-dataset-2\train"
    root_dir_valid=r"D:\AI\File\PyTorch-Tutorial-2nd-main\PyTorch-Tutorial-2nd-main\data\covid-19-dataset-2\valid"
    ...
    ##############COVID19Dataset_3###################
    root_dir=r"D:\AI\File\PyTorch-Tutorial-2nd-main\PyTorch-Tutorial-2nd-main\data\covid-19-dataset-3\imgs"
    path_csv=r"D:\AI\File\PyTorch-Tutorial-2nd-main\PyTorch-Tutorial-2nd-main\data\covid-19-dataset-3\dataset-meta-data.csv"
